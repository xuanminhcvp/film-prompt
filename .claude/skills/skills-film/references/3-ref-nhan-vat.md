...
- **Với nhân vật phụ không có portrait:** Fullbody đầu tiên là thẻ neo nhân dạng. Prompt phải ghi rõ đây là "NHÂN VẬT PHỤ + TRANG PHỤC", khóa trực tiếp tuổi, sắc tộc, khuôn mặt, tóc, vóc dáng, thần thái và bộ đồ trong cùng ảnh. Các fullbody sau của cùng nhân vật phải đính fullbody đầu tiên vào `refs.chars` và ghi: giữ nguyên mặt, tuổi, tóc, vóc dáng, chỉ đổi trang phục.
- **Tối ưu Token:** tuyệt đối không tả lại ngũ quan khuôn mặt trong prompt FULL BODY. Chỉ ghi "Gương mặt giống ảnh portrait tham chiếu" và dành chữ chỉ để tả quần áo. Tránh AI bị "nhiễu" lai tạo mặt.
