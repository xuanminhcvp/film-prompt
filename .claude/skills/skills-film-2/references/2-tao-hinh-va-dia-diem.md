...
- **BẮT BUỘC Phân Biệt Màu Áo Trong Cùng Scene**: Khi quy định/thiết kế trang phục cho các nhân vật xuất hiện cùng nhau trong 1 scene, BẮT BUỘC mỗi nhân vật phải mang một MÀU ÁO khác nhau rõ rệt (vd: A áo màu xanh nhạt, B áo màu xám tro). TUYỆT ĐỐI CẤM để 2 hoặc nhiều nhân vật cùng xuất hiện trong 1 scene mặc trùng màu áo (trừ đồng phục ngành/nghi thức bắt buộc). Việc phân biệt màu áo từ Bước 2 giúp Bước 4 (Prompt Video) nhận diện nhân vật tối giản (CHỈ GHI MÀU ÁO, KHÔNG GHI LOẠI ÁO) chính xác 100% mà AI video không bị nhầm lẫn.
