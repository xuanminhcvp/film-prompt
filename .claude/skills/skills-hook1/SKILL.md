...
| 9 | Tạo 3 thumbnail (`SF-THUMB-01/02/03`, cuối scene `REF`) | [12-thumbnail.md](references/12-thumbnail.md) | 3 thumbnail qua hết §8 Kiểm tra |
...
| Thumbnail — chiến lược 3 ảnh · khoá nhân dạng · luật SF được miễn · câu chặn rác đồ hoạ · tra template (`sfboard/tim-thumbnail.py`) · menu tinh chỉnh | `12-thumbnail.md` |
