...
- **Ngoại lệ cho Hook — KHÔNG tạo portrait cho bất kỳ ai:** Hook không tạo `REF_*_PORTRAIT`, kể cả cho nhân vật chính. Mọi nhân vật (không phân biệt vai trò) đều dùng cơ chế "fullbody đầu tiên làm thẻ neo nhân dạng" ở mục 3 bên dưới. Lý do: Hook chỉ dài 8–12 clip, một ảnh neo 9:16 khóa đủ mặt + đồ là đủ giữ nhân dạng xuyên suốt, không cần tách riêng vòng sinh ảnh chân dung.
