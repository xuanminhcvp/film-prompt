---
name: skills-hook-a-dong
description: Viết/sửa prompt ảnh nhân vật, Start Frame (SF), prompt video Grok và prompt nhạc Suno trong sf-board.json cho các video Hook ngắn (khoảng 2 phút) theo phong cách A Đồng. Dùng skill này mỗi khi tạo REF nhân vật mới, tạo SF, chia shot, viết prompt video có chứa câu dẫn chuyện (narration) và thoại, hoặc sửa ngoại hình nhân vật trong board.
---
...
**LƯU Ý BẮT BUỘC:** Đặc biệt ưu tiên tuân thủ các quy tắc tại [phong-cach-rieng.md] nếu có (references/phong-cach-rieng.md) trong mọi bước.
