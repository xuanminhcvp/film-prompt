#!/usr/bin/env python3
"""Soát độ dài và định dạng kịch bản của skill tai_nang_bi_lam_tro_cuoi_truoc_dam_dong.
...
Định mức nằm ở references/4-hook-va-cta.md, 5-vi-thanh.md mục 5 và SKILL.md mục 1
— sửa ở đó trước, rồi mới sửa hằng số dưới đây.

Đếm từ: chỉ tính token có chữ hoặc số (dấu — đứng riêng không tính là từ).
Golden (GOLDEN-1.txt) đo bằng script này: mở màn 140 từ, lời rủ 50 từ,
toàn bài 7.551 từ, lời rủ cuối 44 từ. Golden báo LỖI định dạng vì viết liền —
...
LOI_RU_TRAN = 55             # Golden 50
LOI_RU_CUOI_TRAN = 70        # 5-vi-thanh.md mục 5 — Golden 44
