...
5. **Dòng kết thúc bắt buộc**: prompt của mọi Thẻ Địa Điểm kết thúc bằng dòng `KHUNG DỌC 9:16` (luật chung: `2-du-lieu-sf-board.md` §8).
...
- [ ] Prompt kết thúc bằng dòng `KHUNG DỌC 9:16`.
