...
- **Tỷ lệ 9:16 (khung dọc)**, góc 3/4. Không có người/tay, chỉ đạo cụ. Vật nằm ngang (thùng dẹt, tờ giấy, dao) thì đặt chéo hoặc dựng nghiêng cho vừa khung dọc, tuyệt đối không đổi sang khung vuông/ngang. Prompt kết thúc bằng dòng `KHUNG DỌC 9:16` (`2-du-lieu-sf-board.md` §8).
...
- [ ] Mọi `REF_PROP_*` là ảnh 9:16 và kết thúc bằng dòng `KHUNG DỌC 9:16`.
