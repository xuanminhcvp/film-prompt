...
>   trần ký tự và dòng kết 9:16 (→ `2-du-lieu-sf-board.md` §8) ·
...
### 1.1 Bản đồ vị trí tường minh — theo BA DẢI DỌC
Mô tả vị trí bằng mốc cụ thể (% khung, landmark), chỉ rõ ai thuộc nhóm nào, tách nhóm dễ nhầm bằng khoảng trống rõ ràng.

**Khung 9:16 chia làm ba dải theo chiều cao, và vị trí phải khai theo dải, không khai theo trái/phải:**

| Dải | Phần khung | Chứa gì |
|---|---|---|
| **Dải trên** | ~25% trên | trần/mái/vòm/bầu trời · người đứng xa nhất của trục sâu |
| **Dải giữa** | ~50% giữa | chủ thể chính, mặt người đang nói — **luôn nằm ở đây** |
| **Dải dưới** | ~25% dưới | lớp tiền cảnh: vai/gáy OTS, mép bàn, lưng ghế, mặt sàn |

- **Khai vị trí bằng cặp (dải + độ sâu)**, VD: *"Marcus ở dải giữa, cách máy khoảng hai bước chân, mặt chiếm 1/4 chiều cao khung; vai trái của Denise chắn góc dưới khung, out nét."* Không viết *"Marcus bên trái, Denise bên phải"* — bề ngang khung dọc quá hẹp để đặt hai người cạnh nhau (`7-bang-shot.md` §3.0).
- **Vùng an toàn UI (bắt buộc chừa)**: nền tảng Short phủ giao diện lên **~12% đỉnh khung** và **~18% đáy khung**. Mặt người đang nói, bàn tay đang làm động tác chính, và mọi chữ cần đọc được (bảng tên, giấy tờ, biển hiệu) đều **phải nằm trong dải giữa**. Đừng đặt chúng sát mép trên hoặc mép dưới.
- **Đỉnh và đáy khung phải có nội dung**, không bỏ trống cả hai đầu (`7-bang-shot.md` §3.0 Hệ quả 4). Prompt bắt buộc nói rõ đỉnh khung nhìn thấy gì và đáy khung nhìn thấy gì.
...
⚠️ **Khung dọc không nới lỏng luật này.** Khung 9:16 buộc phải xếp người theo chiều sâu, nhưng thế so le đó là việc của **bước phân rã thế trận** (`6-cum-va-master-sf.md` §1.1) — nó phải có sẵn trong Master SF. Gặp một Master SF lỡ để nhóm đứng ngang hàng thì cách sửa là **sửa Master SF**, không phải viết prompt SF con đẩy người ra sau lưng cho vừa khung dọc.

### 2.3 Khung một nhân vật (Solo Frame) — viết thế nào

Định nghĩa, định mức và khi nào dùng: `7-bang-shot.md` §3.3. Ở đây chỉ nói cách viết prompt.

- **Không khai người thứ hai, bằng bất kỳ hình thức nào.** Không "vai ai đó ở tiền cảnh", không "bóng người mờ phía sau", không "phản chiếu trên kính". Khai một chữ là AI vẽ ra một người.
- **Hướng mắt phải viết tường minh**, vì đó là thứ duy nhất còn giữ được thế trận: *"<TÊN> nhìn ra ngoài khung về phía bên phải, hơi chếch xuống — đúng chỗ <TÊN B> đang đứng theo Master SF."* Không viết chung chung "nhìn về phía trước".
- **Hậu cảnh phải gánh phần của người thứ hai**: nêu đích danh mốc bối cảnh phía sau lưng nhân vật (mảng tường, quầy, khung cửa, dãy ghế nào của Master SF) để khán giả định vị được nhân vật trong cụm.
- **Quần chúng nền giữ nguyên luật thường** (`9-quan-chung-nen.md`) — khung solo không phải khung vắng người. Người nền vẫn đã dừng việc và quay nhìn về tiền cảnh.
- **Ba dải dọc vẫn áp dụng**: mặt ở dải giữa, đáy khung phải có lớp tiền cảnh gì đó — nhưng lớp tiền cảnh này là **đồ vật** (mép bàn, lưng ghế, thành lan can), không được là người (§1.1).

### 2.4 Góc áp đảo — cấm chếch ngược lên mặt

Khung có ý đồ thể hiện quyền lực/áp đảo: máy ngang tầm mắt, hạ thấp hơn tầm mắt nhân vật một chút, không tilt lên. **Câu chặn bắt buộc chèn vào prompt** (bản gốc, chép đúng nguyên văn): `0-tu-duy-dien-anh.md` §II.3b.
...
11. **Ba dải dọc**: mặt người đang nói nằm ở dải giữa, ngoài vùng an toàn UI (12% đỉnh · 18% đáy); đỉnh khung và đáy khung đều đã khai có gì (§1.1).
12. **Trần người rõ mặt** của cỡ cảnh này chưa bị vượt; không ai bị dàn ngang hàng với người khác (`7-bang-shot.md` §3.0).
12b. **Nếu là Solo Frame**: không một chữ nào khai người thứ hai (kể cả bóng/phản chiếu); hướng mắt đã viết tường minh về đúng phía đối phương; hậu cảnh có mốc định vị; lớp tiền cảnh đáy khung là đồ vật, không phải người (§2.3).
12c. **Nếu là khung áp đảo**: đã chèn câu chặn góc máy của `0-tu-duy-dien-anh.md` §II.3b; không chỗ nào viết low-angle chếch lên.
13. Prompt kết thúc bằng dòng `KHUNG DỌC 9:16` (`2-du-lieu-sf-board.md` §8).
